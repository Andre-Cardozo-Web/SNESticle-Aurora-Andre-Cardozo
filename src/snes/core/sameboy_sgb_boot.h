#ifndef _AURORA_SAMEBOY_SGB_BOOT_H
#define _AURORA_SAMEBOY_SGB_BOOT_H

#include "types.h"

/*
 * Compiled 256-byte bootstrap corresponding to SameBoy's open SGB bootstrap.
 * Source lineage: SameBoy BootROMs/sgb_boot.asm by Lior Halphon.
 * SameBoy is distributed under the Expat License; see
 * LICENSES/SameBoy-Expat.txt and src/third_party/sameboy/LICENSE.
 *
 * SGB2 uses the same image with the FF50 write immediate changed from 0x01
 * to 0xff, matching SameBoy's SGB2 bootstrap.
 */
static const Uint8 g_AuroraSameBoySgbBoot[256] = {
